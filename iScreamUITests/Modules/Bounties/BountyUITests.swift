...
final class BountyUITests: XCTestCase {
    ...
    func testChildCanNavigateToAndSeeBounties() throws {
        ...
        app/*@START_MENU_TOKEN@*/.buttons.images["ice.cream.coin"].firstMatch/*[[".images.matching(identifier: \"ice.cream.coin\").element(boundBy: 0)",".buttons[\"Bounties\"].images.firstMatch",".buttons.images[\"ice.cream.coin\"].firstMatch"],[[[-1,2],[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
