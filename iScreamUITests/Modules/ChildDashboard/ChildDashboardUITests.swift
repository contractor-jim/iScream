...
final class ChildDashboardUITests: XCTestCase {
    ...
    func testChildDashboardCanSeeUI() throws {
        ...
        app.activate()
        XCTAssertTrue(app.staticTexts["Welcome Jack"].waitForExistence(timeout: 3.0))
    ...
    func testChildDashboardCanSeeUINaughtyCell() throws {
        ...
        XCTAssertTrue(app/*@START_MENU_TOKEN@*/.otherElements["child-is-naughty-sectormark-Naughty"]/*[[".otherElements",".otherElements[\"Naughty\"]",".otherElements[\"child-is-naughty-sectormark-Naughty\"]"],[[[-1,2],[-1,1],[-1,0,1]],[[-1,2],[-1,1]]],[0]]@END_MENU_TOKEN@*/
    ...
    func testChildDashboardCanSeeUIBountyCell() throws {
        ...
        XCTAssertTrue(app/*@START_MENU_TOKEN@*/.staticTexts["child-bounty-cell-completed"]/*[[".otherElements",".staticTexts[\"4\/8 bounties completed\"]",".staticTexts[\"child-bounty-cell-completed\"]"],[[[-1,2],[-1,1],[-1,0,1]],[[-1,2],[-1,1]]],[0]]@END_MENU_TOKEN@*/
            .waitForExistence(timeout: 3.0))
    ...
    func testChildDashboardCanSeeUIAchievementCell() throws {
        ...
        XCTAssertTrue(app/*@START_MENU_TOKEN@*/.images["child-dashboard-achievement-cell-midnight"]/*[[".otherElements.images[\"child-dashboard-achievement-cell-midnight\"]",".images[\"child-dashboard-achievement-cell-midnight\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
            .waitForExistence(timeout: 3.0))
