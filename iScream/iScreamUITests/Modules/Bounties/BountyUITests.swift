...
final class BountyUITests: XCTestCase {
    ...
    func testChildCanNavigateToAndSeeBounties() throws {
        ...
        app.activate()
        let trophyFillImage = app/*@START_MENU_TOKEN@*/.images["trophy.fill"]/*[[".buttons[\"Bounties\"].images.firstMatch",".buttons.images[\"trophy.fill\"]",".images[\"trophy.fill\"]"],[[[-1,2],[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/
        trophyFillImage.tap()
